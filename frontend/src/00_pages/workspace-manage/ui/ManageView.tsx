...
import { getManageHref, getNewWorkspaceHref, getTabHref } from "@/entities/workspace/model/data";
import { deleteWorkspace, updateWorkspace } from "@/features/workspace-actions/api/workspaceActions";
